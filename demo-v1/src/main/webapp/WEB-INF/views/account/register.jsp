	...
	<div id="pageContainer">
		...
		<div id="inputcontent">
		    ...
		    <div id="inputmain">
		        ...
		        <form id="registerform" action="register.action" method="post"><!-- 상대경로표시 --><!-- action 은 경로  -->
		        <table>
		            <tr>
		                <th>아이디(ID)</th>
		                <td>
		        ...
		        <div class="buttons">
		        	<input id="register" type="submit" value="등록" style="height:25px" /><!-- submit을 누르면 form 을 서버로 전송 -->
